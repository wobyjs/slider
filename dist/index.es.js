...
const Slider = (props) => {
  ...
  const renderLabels = (labels2) => /* @__PURE__ */ jsx(
    "ul",
    {
      ...
      children: Object.values($$(labels2))
    }
  );
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            tabIndex: 0,
            children: [
              () => $$(showTooltip) ? /* @__PURE__ */ jsx("div", { ref: tooltipRef, class: [
              ...
              /* @__PURE__ */ jsx("div", { class: "rangesliderHandle-label select-none", children: formatLabel })
            ]
          }
        ),
